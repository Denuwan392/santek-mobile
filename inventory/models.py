...
class Item(models.Model):
    ...
    retail_selling_price = models.DecimalField(max_digits=10, decimal_places=2, default=0, null=True)
    retail_minimum_price = models.DecimalField(max_digits=10, decimal_places=2, default=0, null=True)
    wholesale_selling_price = models.DecimalField(max_digits=10, decimal_places=2, default=0, null=True)
